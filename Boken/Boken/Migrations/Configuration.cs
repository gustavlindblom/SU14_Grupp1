    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Boken.Models.BookDataContext>
    {
        ...
        protected override void Seed(Boken.Models.BookDataContext context)
        {
            ...
            context.Books.AddOrUpdate(
                    ...
                    new Book() { Id = 6, Title = "Att Filla eller att Fjonka", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 7, Title = "Angular pagination - eller, Hur jag fick min hjärnblödning", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 8, Title = "Filtrering är nog bara 1/2 scrum-poäng", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 9, Title = "Scrum-master är envåldshärskare, och hör sen!", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 10, Title = "Man äter aldrig kålrabbi, för han är inte b-juden", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 11, Title = "Vad fan är kålrabbi?", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "http://image.bokus.com/images2/9789172632189_200", Summary = "Hobbitar är bara små på utsidan." }
                );
