    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Boken.Models.BookDataContext>
    {
        ...
        protected override void Seed(Boken.Models.BookDataContext context)
        {
            ...
            context.Books.AddOrUpdate(
                    new Book() { Id = 1, Title = "Sagan om Ringen", Year = 1948, Price = 49.9m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/saganomringen.jpg", Summary = "Sagan om ringen eller Härskarringen, i nyöversättning Ringarnas herre (originaltitel The Lord of the Rings), är en fantasyroman av J.R.R. Tolkien. Den utgavs på engelska för första gången 1954–1955 uppdelad i tre volymer med titlarna The Fellowship of the Ring, The Two Towers och The Return of the King. Tolkien hade redan 1937 i Bilbo, en hobbits äventyr, introducerat både härskarringen, och flera av huvudfigurerna i trilogin." },
                    new Book() { Id = 2, Title = "Skånes Historia", Year = 1999, Price = 79.9m, ISBN = "345-371-251-121", InStock = 12, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Jäevlett vikte bog ti å läesa. Ellår iallafall glo på bildårna." },
                    new Book() { Id = 3, Title = "Da Vinci Kodden", Year = 2006, Price = 69.9m, ISBN = "123-762-33-1274", InStock = 67, ImagePath = "/Content/Image/davinci.jpg", Summary = "Da Vinci-koden är en roman av den amerikanske författaren Dan Brown. Den följer en professor i religionssymbolik, Robert Langdon, som blir indragen i en mordutredning i Paris och upptäcker en kamp mellan Prieuré de Sion och Opus Dei över huruvida Jesus från Nasaret var gift och hade barn med Maria Magdalena." },
                    new Book() { Id = 4, Title = "Änglar och Demoner", Year = 1004, Price = 69.9m, ISBN = "373-37-4532-136", InStock = 247, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Änglar och demoner är en bestseller-roman av den amerikanske författaren Dan Brown, utgiven 2000. Den handlar om Harvard-professorn Robert Langdon och dennes ständiga kamp mot klockan under jakten på en mördare tillhörande Illuminati" },
                    new Book() { Id = 5, Title = "Det", Year = 1986, Price = 99.9m, ISBN = "532-234-137-1251", InStock = 12, ImagePath = "/Content/Image/Det.jpg", Summary = "Det (engelsk originaltitel It) är en roman från 1986 av Stephen King. Den gavs ut i svensk översättning 1987.[1] Boken har även filmatiserats." },
                    new Book() { Id = 6, Title = "Att Filla eller att Fjonka", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 7, Title = "Angular pagination - eller, Hur jag fick min hjärnblödning", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 8, Title = "Filtrering är nog bara 1/2 scrum-poäng", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 9, Title = "Scrum-master är envåldshärskare, och hör sen!", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 10, Title = "Man äter aldrig kålrabbi, för han är inte b-juden", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." },
                    new Book() { Id = 11, Title = "Vad fan är kålrabbi?", Year = 1948, Price = 9.99m, ISBN = "123-234-643-12", InStock = 46, ImagePath = "/Content/Image/anglarodemoner.jpg", Summary = "Hobbitar är bara små på utsidan." }
                );
